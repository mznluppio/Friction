...
export const PromptInputActionMenuTrigger = forwardRef<HTMLButtonElement, PromptInputActionMenuTriggerProps>(
...
export const PromptInputSubmit = forwardRef<HTMLButtonElement, PromptInputSubmitProps>(
  ({ className, variant = "default", size = "icon-sm", status, onStop, onClick, children, ...props }, ref) => {
